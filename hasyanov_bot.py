...
# 📜 Полный текст оферты
FULL_OFFER = (
    "📌 Условия использования бота и услуг Исполнителя (Хасянова Ибрахима Галимовича):\n\n"
    "• Договор считается заключённым при нажатии кнопки «Принять оферту», оплате занятия или фактическом участии ученика в уроке после получения ссылки на оферту.\n"
